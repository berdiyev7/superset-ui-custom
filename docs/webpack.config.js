      ...
      rules: [
         ...
         },
         {
            ...
            exclude: [
               ...
               /superset-ui-plugins.*\/node_modules\//,
               /\.test.jsx?$/,
            ],
            include: [
               new RegExp(`${APP_DIR}/src`),
               /superset-ui.*\/src/,
               /superset-ui-plugins.*\/src/,
         ...
         {
            test: /\.css$/,
            include: [APP_DIR, /superset-ui.+\/src/, /superset-ui-plugins.+\/src/],
            use: [
...
if (isDevMode) {
   ...
   Object.entries(packageConfig.dependencies).forEach(([pkg, version]) => {
      ...
      if (
         (/superset-ui/.test(pkg) || /superset-ui-plugins/.test(pkg)) &&
